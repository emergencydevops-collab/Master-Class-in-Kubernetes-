...
## Step-E02: Pre-requisite - Metric server
- Metric server should be installed & ready, we have done that as part of HPA

## Step-E03: Deploy the Vertical Pod Autoscaler (VPA)
```
# Clone Repo
...
## Step-E04: Review & Deploy our Application Manifests (Deployment & Service)
...
```
# Deploy Application
kubectl apply -f kube-manifests/E01-VPA-DemoApplication.yml
...
## Step-E05: Create & Deploy VPA manifest
...
```
# Deploy
kubectl apply -f kube-manifests/E02-VPA-Manifest.yml
...
## Step-E07: Describe pods which were re-launched by VPA Updater
```
# List Pods
kubectl get pods
...
## Step-E08: Important Nodes about VPA:
